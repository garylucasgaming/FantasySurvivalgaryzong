...
public static class BlockHelper
{
    ...
    public static Vector2Int TexturePosition(Direction direction, BlockType blockType)
    {
        switch(direction)
        {
            case Direction.up: return BlockDataManager.blockTextureDataDictionary[blockType].up;
            case Direction.down: return BlockDataManager.blockTextureDataDictionary[blockType].down;
            default: return BlockDataManager.blockTextureDataDictionary[blockType].side;
        }
}
}